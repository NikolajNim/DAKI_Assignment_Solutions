...
def main():
    ...
    print("+-------------------------------+")
    image_path = r"C:\Users\Nikolaj Nim\OneDrive - Aalborg Universitet\Dokumenter\GitHub\DAKI_Assignment_Solutions\KingDomino\KingDominoTestData\17.jpg"
...
def get_terrain(tile):
    ...
    if 24 < hue < 30 and 135 < saturation < 253 and 143 < value < 201:
